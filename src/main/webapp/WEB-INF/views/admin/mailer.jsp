			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">Booking Confirmation Mailer</h1>
					</div>
					...
					<div class="col">
					<div class="card">
					<div class="card-heading">Sending booking confirmation mail</div>
					<div class="card-body">
					<form action="${cp}/admin/booking/confirm-message" method="post">
					
					<input type="hidden" name="${_csrf.parameterName }" value="${_csrf.token }" />
						
						<div class="form-group">
						<label>To: </label>
						<input type="text" name="to" value="${mail_to}" >
						</div>
						
						<div class="form-group">
						<label>Subject: </label>
						<input type="text" name="subject"  value="${mail_subject}" required>
						</div>
						
						<div class="form-group">
						<label>Message: </label>
						<textarea name="message" rows="7" cols="100" required>${mail_message}</textarea>
						</div>
